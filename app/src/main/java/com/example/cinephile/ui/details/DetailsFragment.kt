...
class DetailsFragment : Fragment() {
    ...
    private var isUpdatingRatingBar = false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launchWhenStarted {
            viewModel.uiState.collect { state ->
                ...
                if (binding.ratingBar.rating != userRating) {
                    isUpdatingRatingBar = true
                    binding.ratingBar.rating = userRating
                    isUpdatingRatingBar = false
                }
    ...
    private fun setupRatingBar() {
        ...
        binding.ratingBar.isClickable = true
        binding.ratingBar.isFocusable = true
        
        binding.ratingBar.setOnRatingBarChangeListener { ratingBar, rating, fromUser ->
            android.util.Log.d("DetailsFragment", "RatingBar changed: rating=$rating, fromUser=$fromUser, isUpdating=$isUpdatingRatingBar")
            if (!isUpdatingRatingBar && fromUser) {
